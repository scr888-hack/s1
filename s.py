    ...
    try:
        ...
        if op.type == 13:
            ...
            if settings["autoJoin"] == True:
                ...
                maxgie.sendMessage(op.param1, str(settings["welcome"]))
                maxgie.sendMessage(op.param1, str(settings["comment"]))
        if op.type == 13:
            ...
            if settings["autoJoin"] == True:
                if settings["autoCancel"]["on"] == True:
                    if len(group.members) > settings["autoCancel"]["members"]:
                        ...
                        maxgie.rejectGroupInvitation(op.param1)
                else:
                    maxgie.acceptGroupInvitation(op.param1)
            gInviMids = []
            ...
            if gInviMids != []:
                for j in gInviMids:
                    name_ = maxgie.getContact(j).displayName
                    listContact += "\n      + {}".format(str(name_))
        if op.type == 13:
            ...
            dataProfile = [
                {
                    ...
                    "header": {
                        ...
                        "contents": [
                            {
                                "type":"image",
                                "url":"https://data.bloggif.com/distant/user/store/d/8/e/8/971e241f5cded971fe79525a00d68e8d.gif",
                                "aspectMode":"cover",
                                "margin":"xxl",
                                "aspectRatio":"1:1",
                                "size":"full",
                                "action":{
                                    "type":"uri",
                                    "uri":"https://line.me/ti/p/-pMXBTqNP5"
                                },
                            },
                        ]
                    },
...
#==============================================================================#
                if msg.text in ('sss'):
                    uHelp = uhelp()
                    maxgie.sendMessage(to, str(uHelp))
                    maxgie.sendContact(to, "u24d5f93f9113c991342c079005467e2f")
                elif text.lower() == 'texttospeech':
                    helpTextToSpeech = helptexttospeech()
                    maxgie.sendMessage(to, str(helpTextToSpeech))
                elif text.lower() == '':
                    maxgie.sendMessage(msg.to, "help")
                if text.lower() == "ประกาศ":
                    sa="วิธีใช้ ประกาศกลุ่ม >\\<"
                    sa+="\n- ประกาศ ข้อความ/ไอดีไลน์"
                    sa+="\nตัวอย่าง >\\<"
                    sa+="\n- ประกาศ มอนิ่ง/aboutme.."
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "Maxgie Botline", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u24d5f93f9113c991342c079005467e2f"}}
                  ...
                  if msg._from in admin:
                    ...
                    try:
                      ...
                      try:
                          tagadd["tag"] = text_
                          sa = "「 ตั้งคำแทค 」\nคือ : " + text_
                          data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "STEVE Botline", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u24d5f93f9113c991342c079005467e2f"}}
                          sendTemplate(to,data)
                      except:
                ...
                if text.lower() == "help" or text.lower() == "คำสั่ง":
                            ...
                            sendTemplate(to, data)
                if text.lower() == "Hiallbet" or text.lower() == "hi":
                            s = "#FF0000"
                            sa = """  สมัครสมาชิกใหม่จัดไป โบนัส 100%
   📌Hiallbet อาณาจักรเดิมพัน 
    รวม 14 เว็บ
    ภายใต้บริการไว้ในเว็บเดียว
   🎯สมัครพร้อมฝาก เปิดยูส 300 บาท
   🎀รับโบนัสต้อนรับ 100% ทันที
------------------------------
                            ...
                            dataProfile = [
                                {
                                    ...
                                    "header": {
                                        ...
                                        "contents": [
                                            {
                                                "type": "image",
                                                "url": 'https://www.img.in.th/images/11f56621f873312f76b193684a770fe1.jpg',
                                                "size": "full"
                                            },
                                            {
                                                "type": "text",
                                        ...
                                        #        "size": "md"
                                            ...
                                            },
                                            {
                                                 ...
                                                 "action":{
                                                     "type":"uri",
                                                     "label":"สมัครคลิ๊ก",
                                                     "uri":"https://www.hiallbet.com/affr=2485"
                                                 },
                                            },
                                        ]
                                    },
...
------------------------------\n"""
                            ...
                            sendTemplate(to, data)
                if text.lower() == "sl" or text.lower() == "update":
                            dataProfile = [
                                {
                                    "type": "bubble",
                                    "styles": {
                            ...
                            data = {
                                "type": "flex",
                                "altText": "⚜️⚜️ อัพเดตเพจโกงจ้าาา ⚜️⚜️",
                                "contents": {
                                    "type": "carousel",
                                    "contents": dataProfile
                                }
                            ...
                            sendTemplate(to, data)
                if text.lower() == "bot" or text.lower() == "บอท":
                            s = "#FF0000"
                            sa = """ คำสั่งทั่วไป

[1] .update ส่งข้อความไปทุกกลุ่ม

[2] /update ส่งข้อความหาเพื่อนทุกคน 

[3] update เรียกดูตัวอย่าง

[4] gbc ข้อความที่ส่งไปกลุ่ม/ไอดีไลน์ของเรา

[5] fbc ข้อความที่ส่งหาเพื่อน/ไอดีไลน์ของเรา

[6] ยูทูป ชื่อที่ต้องการค้นหา

[7] bye @คนที่ต้องการเตะ

[8] help เรียกดูคำสั่งทั้งหมด
              ...
              #                                  "text": " "
               #                             },
                #                            {
                            ...
                            data = {
                                "type": "flex",
                                "altText": "⚜️⚜️ ไม่มีที่ไหนอีกแล้ว อยากรู้เปิดอ่านสิ ⚜️⚜️",
                                "contents": {
                                    "type": "carousel",
                                    "contents": dataProfile
                                }
...
#=====================================================================
                ...
                if text.lower() == "คท":
                    maxgie.generateReplyMessage(sender) 
                ...
                if text.lower() == "mid" or text.lower() == "ไอดีเรา":
                    ...
                    maxgie.sendReplyMessage(msg.id, to,maxgieMID)
                            ...
                            h = maxgie.getContact(sender)
                            cu = maxgie.getProfileCoverURL(sender)
                            image = str(cu)
                            maxgie.generateReplyMessage(msg.id)
                            maxgie.sendReplyImageWithURL(msg.id, to, image)
                if text.lower() == "me2":
                ...
                if text.lower() == "/allpage" or text.lower() == "/redscr":
#                            g = maxgie.getGroup(op.param1)
   #                         contact = maxgie.getContact(op.param2)
      #                      cover = maxgie.getProfileCoverURL(op.param2)
         #                   gname = g.name
   ...
   #                         s += "บายยน้า : {}".format(name)
                            s = "#FFCC00"
                            s = "✔️สมาชิกใหม่รับโบนัส 100%\n"
                            s += "✔️ฝากแรกของวัน 20%\n"
                            s += "✔️ฝากขั้นต่ำ 100บาท\n"
                            s += "✔️ถอนขั้นต่ำ 100บาท\n"
                            s += "✔️Jackpot-ซองแดง ไม่ทำเทิร์น\n"
                            s += "✔️การเงิน มั่นคง มั่นใจ 💯\n"
    #                        s += "✔️สมัครง่ายคลิ๊กเลย\n"
                            s += tagadd["wctext"]
                            data = {
"type":"flex","altText":" 🌸  แจกเครดิตฟรีจ้าพี่ 🌸 ","contents":{"styles":{"header":{"backgroundColor":"#000000","separator":True,"separatorColor":"#FFFFFF"},"body":{"backgroundColor":"#000000","separator":True,"separatorColor":"#FFFFFF"},"footer":{"backgroundColor":"#000000","separator":True,"separatorColor":"#FFFFFF"}},"type":"bubble","header":{"type":"box","layout":"horizontal","contents":[{"type":"button","style":"secondary","color":"#990000","height":"sm","gravity":"center","flex":1,"action":{"type":"uri","label":"⫷ สมัครแบบรับเครดิตฟรี ⫸","uri":"http://bit.ly/32abxRN"}}]},"hero":{"type":"image","url":"https://www.img.in.th/images/b02b0a57ffbdd14f9ba81b129d85df9a.gif","aspectMode":"cover","margin":"xxl","aspectRatio":"1:1","size":"full","action":{"type":"uri","uri":"http://bit.ly/2L2VAqS"}},"body":{"type":"box","layout":"horizontal","spacing":"md","contents":[{"type":"separator","color":"#FFFFFF"},{"type":"box","layout":"vertical","flex":0,"contents":[{"type":"separator","color":"#FFFFFF"},{"type":"image","url":"https://www.img.in.th/images/b02b0a57ffbdd14f9ba81b129d85df9a.gif","size":"sm","gravity":"bottom"}]},{"type":"separator","color":"#FFFFFF"},{"type":"box","layout":"vertical","flex":2,"contents":[{"type":"text","text":"RED SCR","color":"#990000","size":"xxl","weight":"bold","flex":3,"wrap":True,"gravity":"top"},{"type":"separator","color":"#FFFFFF"},{"type":"separator","color":"#FFFFFF"},{"type":"text","text": "{}".format(s),"color":"#FFCC00","size":"sm","weight":"bold","flex":3,"wrap":True,"gravity":"top"},{"type":"separator","color":"#FFFFFF"},{"type":"separator","color":"#FFFFFF"},{"type":"text","text":"✔️สมัครง่ายๆคลิ๊กเลย","color":"#FFCC00","size":"sm","weight":"bold","flex":3,"wrap":True,"gravity":"top"},{"type":"separator","color":"#FFFFFF"}]}]},"footer":{"type":"box","layout":"horizontal","contents":[{"type":"button","style":"secondary","color":"#990000","height":"sm","gravity":"center","flex":1,"action":{"type":"uri","label":"⫷ สมัครแบบเติมเงิน ⫸","uri":"http://bit.ly/2L2VAqS"}},{"type":"spacer","size":"sm"}],"flex":0}}}
                            sendTemplate(to, data)
                elif text.lower() == "/me":
                            s = temp["te"]
                            a = temp["t"]
                ...
                if text.lower() == "ออน" or text.lower() == "runtime":
                    ...
                    sendTemplate(to, data)
                    restartBot()
                if text.lower() == "sp" or text.lower() == "/sp" or text.lower() == "/สปีด":
                    start = time.time()
                ...
                if text.lower() == "sp" or text.lower() == "speed":
                    ...
                    sendTemplate(to, data)
                elif text.lower() == 'ข้อมูลบอท' or text.lower() == "about":
                    try:
                        arr = []
  ...
  #                      ret_ += "\n├ กลุ่ม : 370"
    ...
    #                    ret_ += "\n├ บล็อค : {}".format(str(len(blockedlist)))
                        ...
                        ret_ += "\n╰───「 สนใจเช่าบอท line.me/ti/p/~vipscanner_win  」"
                        ...
                        data = {
                            ...
                            "sentBy": {
                                 "label": "{}".format(maxgie.getContact(maxgieMID).displayName),
                                 "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),
                                 "linkUrl": "https://line.me/ti/p/~vipscanner_win"
                            }
                        }
                        sendTemplate(to, data)
                        ...
                        maxgie.sendMessage(msg.to, str(e))
                                    ...
                                    "columns": [
                                        {
                                            ...
                                            "action": {
                                                "type": "uri",
                                                "uri": "https://line.me/ti/p/~vipscanner_win"
                                            }
                                        }
                                    ]
                                }
                            ...
                            sendTemplate(to, data)
                elif text.lower() == "พุ่ง" or text.lower() == "ฉีด":
                       ...
                       for target in targets:
                           if not target in admin:
                               try:
                                   ...
                                   maxgie.sendMessage(msg.to,"Error")
#=======================================================================================
                elif 'w: ' in msg.text:
                     if msg._from in admin and Owner:
                        spl = msg.text.replace('w: ','')
                        if spl in [""," ","\n",None]:
                         maxgie.sendMessage(msg.to, "❋ตั้งข้อความเรียบร้อยแล้ว❋")
                     else:
...
#-------------------------------------------------------------------------------
                    ...
                    if msg._from in admin:
                        ...
                        for i in gMembMids:
                             maxgie.cancelGroupInvitation(msg.to,[i])
                        else:
                             maxgie.sendMessage(msg.to, "*เรียบร้อย*")
                elif msg.text in ["เชิญ"]:
                    if msg._from in admin:
                        settings["winvite"] = True
                        maxgie.sendMessage(msg.to,"ส่งคอนแทคเพื่อเชิญได้เลยคับ")
                    else:
                        maxgie.sendMessage(msg.to,"คุณไม่มีอำนาจสั่ง")
#=====================================================================
#=====================================================================
...
#==============================================================================#
         ...
         #                   maxgie.sendMessage(to, "ส่งคำประกาศจำนวน {} กลุ่ม".format(str(len(groups))))
                ...
                elif text.lower() == "Allscanwin" or text.lower() == ".update":
                            groups = maxgie.getGroupIdsJoined()
                            for group in groups:
                                dataProfile = [
                                    {
                                ...
                                data = {
                                    "type": "flex",
                                    "altText": "⚜️⚜️ อัพเดตเพจโกงจ้าคุณพี่ ⚜️⚜️",
                                    "contents": {
                                        "type": "carousel",
                                        "contents": dataProfile
                                    }
...
#                            for friend in friends:
                                ...
                                data = {
                                    "type": "flex",
                                    "altText": "⚜️⚜️ เข้ากลุ่มรับเงินสดฟรี ⚜️⚜️",
                                    "contents": {
                                        "type": "carousel",
                                        "contents": dataProfile
                                    }
                                ...
                                sendTemplate(i, data)
                                time.sleep(1)
                            maxgie.sendMessage(to, "ส่งคำประกาศจำนวน {} คน".format(str(len(gid))))
                            ...
                            for group in groups:
                                ...
                                sendTemplate(group, data)
                                time.sleep(1)
#                            maxgie.sendMessage(to, "ส่งคำประกาศจำนวน {} 
#==============================================================================#
                elif text.lower() == "แทค":
